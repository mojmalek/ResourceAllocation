...
//                containerController.kill();
    ...
    public static void scaleFreeSim() throws StaleProxyException, IOException {
        ...
        SimEngAgent simulationEngine1, simulationEngine2;
...
//        String agentType2 = "ScaleFree-NoCas-A";
        ...
        for (int numberOfAgents = 8; numberOfAgents <= 40; numberOfAgents += 8) {
            ...
            for (int exp = 1; exp <= 5; exp++) {
                ...
                String logFileMaster1 = "logs/" + "Master-" + agentType1 + "-numberOfAgents=" + numberOfAgents + "-exp" + exp + "-" + new Date() + ".txt";
//                String logFileMaster2 = "logs/" + "Master-" + agentType2 + "-exp" + exp + "-param=" + param + "-" + new Date() + ".txt";
                String logFileAll1 = "logs/" + "All-" + agentType1 + "-numberOfAgents=" + numberOfAgents + "-exp" + exp + "-" + new Date() + ".txt";
