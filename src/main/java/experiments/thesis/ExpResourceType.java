                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            ...
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, i, numberOfEpisodes, smallWorldAdjacency[i - 1], logFileAll, simEngResourceType, agentType, simEngResourceType.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            ...
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, i, numberOfEpisodes, scaleFreeAdjacency[i - 1], logFileAll, simEngResourceType, agentType, simEngResourceType.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
                        agentControllers.add( agentController);
                    } catch (StaleProxyException e) {
                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            ...
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, i, numberOfEpisodes, randomAdjacency[i - 1], logFileAll, simEngResourceType, agentType, simEngResourceType.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
                        agentControllers.add( agentController);
                    } catch (StaleProxyException e) {
