    ...
    public static void smallWorldSim() throws StaleProxyException, IOException {
        ...
        for (int exp = 1; exp <= 5; exp++) {
            ...
            for (packageSize = 1; packageSize <= 5; packageSize += 1) {
                ...
                String logFileAll = "logs/" + "All-" + agentType + "-exp" + exp + "-param=" + packageSize + "-" + new Date() + ".txt";
...
//              profile.setParameter(Profile.GUI, "true");
                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLMasterAgent", new Object[]{numberOfAgents, numberOfEpisodes, smallWorldGraph, smallWorldAdjacency, logFileMaster, resultFileCen, resultFileDec, agentType, simEngTransferCost.maxTaskNumPerAgent, simEngTransferCost.resourceTypesNum, simEngTransferCost.maxResourceTypesNum, trainedModelPath, packageSize});
                            agentController.start();
                        } else {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, numberOfEpisodes, smallWorldGraph, smallWorldAdjacency[i - 1], logFileAll, simEngTransferCost, agentType, simEngTransferCost.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
...
//              profile.setParameter(Profile.GUI, "true");
                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLMasterAgent", new Object[]{numberOfAgents, numberOfEpisodes, scaleFreeGraph, scaleFreeAdjacency, logFileMaster, resultFileCen, resultFileDec, agentType, simEngTransferCost.maxTaskNumPerAgent, simEngTransferCost.resourceTypesNum, simEngTransferCost.maxResourceTypesNum, trainedModelPath, packageSize});
                            agentController.start();
                        } else {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, numberOfEpisodes, scaleFreeGraph, scaleFreeAdjacency[i - 1], logFileAll, simEngTransferCost, agentType, simEngTransferCost.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
                        agentControllers.add( agentController);
                    } catch (StaleProxyException e) {
...
//                containerController.kill();
    ...
    public static void randomSim() throws StaleProxyException, IOException {
        ...
        for (int exp = 1; exp <= 5; exp++) {
            ...
            String trainedModelPath = "trained_models/transferCost" + numberOfAgents + "random" + exp;
...
//              profile.setParameter(Profile.GUI, "true");
                ...
                for (int i = 0; i <= numberOfAgents; i++) {
                    ...
                    try {
                        if (i == 0) {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLMasterAgent", new Object[]{numberOfAgents, numberOfEpisodes, randomGraph, randomAdjacency, logFileMaster, resultFileCen, resultFileDec, agentType, simEngTransferCost.maxTaskNumPerAgent, simEngTransferCost.resourceTypesNum, simEngTransferCost.maxResourceTypesNum, trainedModelPath, packageSize});
                            agentController.start();
                        } else {
                            agentController = containerController.createNewAgent(agentType + i, "agents.DeepRLSocialAdaptiveAgent", new Object[]{numberOfAgents, numberOfEpisodes, randomGraph, randomAdjacency[i - 1], logFileAll, simEngTransferCost, agentType, simEngTransferCost.maxRequestQuantity, trainedModelPath, packageSize});
                            agentController.start();
                        }
                        agentControllers.add( agentController);
                    } catch (StaleProxyException e) {
